...
@Component({
  selector: 'app-seller-approval-invoice-modal',
  templateUrl: './seller-approval-invoice-modal.component.html',
  styleUrls: ['./seller-approval-invoice-modal.component.scss']
})
