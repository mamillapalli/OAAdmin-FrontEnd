...
@Component({
  selector: 'app-newsbrmain',
  templateUrl: './newsbrmain.component.html',
  styleUrls: ['./newsbrmain.component.scss']
})
export class NewsbrmainComponent implements OnInit {
  public gfg = false;
  ...
  initForm() {
    ...
    console.log(this.defaultValues.counterPartyId)
    let cou: any = this.defaultValues.counterParties;
    if(cou.length > 0)
    {
      this.counterParties =  cou;
    }
  ...
  updateForm()
  {
    ...
    console.log(this.counterParties['customerId'])
    console.log(this.counterParties['customerId'])
  ...
  openAgreementModal() {
    ...
    modalRef.result.then((result) => {
      ...
      if (result) {
        ...
        this.f.counterParties.patchValue(result.counterParties)
        //     this.f.sbrReferenceId.setValue(result.sbrId);
        //   this.f.anchorId.setValue(result.anchorCustomer['customerId']);
        // this.f.counterPartyId.setValue(result.counterParty['customerId']);
        // this.f.agreementId.setValue(result.agreement['contractReferenceNumber']);
